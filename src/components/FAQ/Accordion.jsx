...
const Accordion = ({question, answer}) => {
    ...
    return (
        <div className="md:py-2 border-b border-[#7e7e7e] dm-sans mb-4 md:mb-9">
            <button 
            ...
            >
                <h4>{question}</h4>
                {isOpen ? <FontAwesomeIcon icon={faAngleUp} size='xl' /> : <FontAwesomeIcon icon={faAngleDown} size='xl'/>}
            </button>
