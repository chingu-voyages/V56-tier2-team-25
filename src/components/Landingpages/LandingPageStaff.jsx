      ...
      <div className="min-h-screen w-full flex flex-col">
        ...
        <div className="flex flex-1 flex-col items-center py-11 md:py-4  md:justify-center bg-[#F5F3EA]">
          <div className="flex flex-col text-center items-center justify-center mb-16 md:h-[80vh]">
            <h1 className="text-[#006B44] font-bold md:font-semibold text-[1.125rem] md:text-[2rem] dm-sans px-14 md:px-0 mb-9 mt-20 sm:text-[2rem] 1.sm:mb-16">
            ...
            <div className="flex flex-col items-center text-center justify-center">
              ...
              <div className="flex flex-col items-center text-center justify-center gap-0 md:gap-6 sm:flex-row mb-10">
