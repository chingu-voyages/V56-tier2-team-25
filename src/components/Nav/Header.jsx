...
const Header = () => {
    ...
    return (
        <header className="flex w-full h-[108px] items-center transition-all duration-300 shadow-2xl px-[26px] md:px-0 lg:bg-white bg-[rgba(168,213,186,0.3)]">
             <div 
            ...
            <div className="container mx-auto flex items-center md:px-2 lg:py-[28px]">
                <div className='w-full flex lg:gap-4 items-center justify-center md:justify-start cursor-pointer' onClick={() => navigate("/")} >
                    ...
                    <span className='lg:hidden absolute top-20 right-7 md:ml-1 lg:mt-[.6rem] pb-3 lg:pb-0 text-[#4F4F4F] text-[.75rem] lg:text-base font-bold lg:font-medium'>{date}</span>
